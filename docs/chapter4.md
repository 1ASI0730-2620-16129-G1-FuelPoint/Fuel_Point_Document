...
*Sección reservada para el diagrama de contenedores de la arquitectura del sistema según el modelo C4, a ser incorporado por el integrante asignado según el reparto de trabajo del equipo.*
