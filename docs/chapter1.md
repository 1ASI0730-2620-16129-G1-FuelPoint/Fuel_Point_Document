...
| alt="Joan Salvador Carhuayal Suarez" width="80"> | Joan Salvador Carhuayal Suarez | U202219040 | Ingeniería de Software | Estudiante de Ingeniería de Software en la UPC, tengo conocimientos en los lenguajes de programación de Python, C++, HTLM, CSS y JavaScript. Me gusta el mundo de la tecnología y el desarrollo de software, espero seguir mejorando mis habilidades y conocimientos para formarme como profesional.|
...
![Lean UX Canvas de la solución FullTank](../assets/chapter1/lean-ux-canvas2.0.png)
