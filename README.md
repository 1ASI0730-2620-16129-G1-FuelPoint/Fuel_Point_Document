...
|---|---|---|---|
| 0.1.0 | 2026-08-28 | Equipo FuelPoint | Se creó la estructura del informe para AV1, se redactó el Capítulo I y se incorporaron las secciones exigidas para el Sprint 1. |
...
> La planificación interna para completar esta versión se encuentra en [docs/AV1_ROADMAP.md](docs/AV1_ROADMAP.md).
